...
A good testing method should have easily maintained test cases as well as simple reproduction procedure. When two quality analysts communicate with each other on similar testing tasks, some test cases are likely run by both of them. 
